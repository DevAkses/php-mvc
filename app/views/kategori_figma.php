...
<body>
    <div class="bg-black">
        ...
        <div class="z-1">
            <div class="px-5" style="padding-top: 90px; padding-bottom: 150px;" >
                ...
                <form class="" role="search" id="video_bg" action="" method = "POST">
                    <!-- <button class="btn btn-outline-success" type="submit">Search</button> -->
                    
                <div class="" id="video_bg">
                    <ul class="list-group">
                    <?php foreach( $data['video'] as $video) : ?>
                        <li class="list-group-item my-1 w-100 "> <?= $video['video_title']  ?><a class="btn btn-primary float-end " href="?controller=kategori_figma&method=detail&params=<?= $video['video_id']; ?>" role="button">Nonton Video</a> </li>
    ...
    keyword.addEventListener('keyup', function() {
        ...
        //eksekusi ajax 
        xhr.open('GET', '?controller=kategori_figma&method=cari&params=' + keyword.value, true);
        xhr.send();
